...
class BatchCreator:
    ...
    def build_batches(self):
        ...
        #self.batches: list of bucketing.BucketBatch
    ...
    def batch_to_tensor(self, b):
        ...
        for k, v in tensors_dict_arrays.items():
            ...
            if k not in ['doc_name', 'graph', 'para', 'cword_spans', 'clusters']:
                result[k] = torch.as_tensor(v)
            else:
                result[k] = v
        return result
...
#                if tok_ids == self.tokenizer.pad_token_id:
#                    attention_mask[idx] = 0
        ...
        return {
            ...
            "lsp_embedding": document.data.lsp_embedding,
            "lsp_label": document.data.lsp_label,
            "cword_spans": document.data.cword_spans,
            "clusters": clusters,
        }
